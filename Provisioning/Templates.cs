...
namespace Pzl.O365.ProvisioningFunctions
{
    /*
    public static class Templates
    {
        ...
        public static async Task<HttpResponseMessage> Post1([HttpTrigger(AuthorizationLevel.Function, "post")]BodyClass myinput, TraceWriter log)
        {
        ...
        [Display(Name = "Test Post", Description = "This is a longer description")]
        public static async Task<BodyClass> Post2([HttpTrigger(AuthorizationLevel.Function, "post")]BodyClass myinput, TraceWriter log)
        {
            log.Info("C# HTTP trigger function processed a request.");
            return myinput;
        }
        ...
        public static async Task<Result<string>> Get2([HttpTrigger(AuthorizationLevel.Function, "get", Route = "TemplateGet2/name/{name}/id/{id}")]HttpRequestMessage req, string name, int id, TraceWriter log)
        {
            log.Info("C# HTTP trigger function processed a request.");
        ...
        public static void Get4([HttpTrigger(AuthorizationLevel.Function, "get", Route = "TemplateGet4")][FromUri]UriClass input, TraceWriter log)
        {
            log.Info("C# HTTP trigger function processed a request.");
        }
